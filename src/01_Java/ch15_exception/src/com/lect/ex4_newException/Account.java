...
public class Account {
	...
	public void withdraw(int money) throws Exception{ // 잔액 부족시 "떼끼" 출력
		if(balance >= money) {
			balance -= money; // balance = balance - money;
		}else {
			throw new Exception(money+"원 출금하기에는 잔액("+balance+")이 부족합니다");
		}
	}
	@Override
	public String toString() {
		return "계좌번호:"+accountNo+", "+ownerName+"님 잔액은 "+balance;
	}
